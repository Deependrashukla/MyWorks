...
def test_cmyk_to_rgb():
    ...
    rgb = a3.cmyk_to_rgb(cmyk)
    introcs.assert_equals(217, round(rgb.red))
    introcs.assert_equals(35, round(rgb.green))
    introcs.assert_equals(163, round(rgb.blue))
...
def test_hsv_to_rgb():
    ...
    rgb = a3.hsv_to_rgb(hsv)
    introcs.assert_equals(243, round(rgb.red))
    introcs.assert_equals(12, round(rgb.green))
    introcs.assert_equals(50, round(rgb.blue))
